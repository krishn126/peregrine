...
print(f"SNPE slope: {slope}, intercept: {intercept}")
...
# Generate best-fit line in log space
x_fit_1 = np.logspace(np.log10(min(x_1_fit)), np.log10(max(x_1_fit)), 100)  # Log-spaced x values
...
#plot horizontal line at  y_1[11]
plt.axhline(y=y_1[10], color='orange', linestyle='--', label=f"TMNRE Converged loss")
