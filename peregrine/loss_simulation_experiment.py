...
# Sample data
x = np.array([134272, 67072, 26752, 13312, 6656, 3968, 2560, 1280, 128])  # simulation number variables #128
y = np.array([-4.79168, -3.5644, -2.19829, -0.26212, 0.91438, 1.30695, 5.24674, 6.31091, 8.74037])  # val loss variables #8.74037
...
x_fit = np.array([134272, 67072, 26752, 13312, 6656, 3968])  # simulation number variables
y_fit = np.array([-4.79168, -3.5644, -2.19829, -0.26212, 0.91438, 1.30695])  # val loss variables
