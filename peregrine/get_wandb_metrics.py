...
# plt.plot(history_1["_step"], history_1["train_loss"], label="Train Loss - MAF", color="green")
# plt.plot(valid_1["_step"], valid_1["val_loss"], label="Validation Loss - MAF", color="purple", linestyle="--")
